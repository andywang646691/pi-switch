...
const zh: Record<string, string> = {
  ...
  "Cost-first": "成本优先",
  "Chain selection": "选择模式",
  "Stability-first (healthiest node first, adaptive)": "稳定优先（选历史表现最好的节点，自适应）",
  "Cost-first (configured order, immediate failback)": "成本优先（按配置顺序，恢复后立即回切）",
  "Add rule": "新增规则",
  "Save rules": "保存规则",
  "Rules saved": "规则已保存",
